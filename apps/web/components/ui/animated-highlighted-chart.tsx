...
const chartData = [
  { month: "00:00", desktop: 342, mobile: 245 },
  { month: "03:00", desktop: 876, mobile: 654 },
  { month: "06:00", desktop: 512, mobile: 387 },
  { month: "09:00", desktop: 629, mobile: 521 },
  { month: "12:00", desktop: 458, mobile: 412 },
  { month: "15:00", desktop: 781, mobile: 598 },
  { month: "18:00", desktop: 394, mobile: 312 },
  { month: "21:00", desktop: 925, mobile: 743 },
  { month: "24:00", desktop: 647, mobile: 489 },
];
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Hourly throughput (24h)</CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer config={chartConfig}>
          ...
          >
            ...
            <defs>
              ...
              <linearGradient id="animated-highlighted-grad-desktop" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-desktop)" stopOpacity={0.4} />
                <stop offset="95%" stopColor="var(--color-desktop)" stopOpacity={0} />
              </linearGradient>
              <linearGradient id="animated-highlighted-grad-mobile" x1="0" y1="0" x2="0" y2="1">
